...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (productId) {
        ...
        // .then(product => {
            ...
            //price = parseFloat(product.productPrice) * (100 - parseFloat(product.discountPercent)) / 100;
            ...
            document.querySelector(".main-container .avgRating .rating").textContent = 4.8 ;
            document.querySelector(".main-container .productReview .reviewCount").textContent = 486 + " đánh giá";
            document.querySelector(".main-container .price").textContent = formatNumber(parseInt(product.price)) + " đ";
            document.querySelector(".main-container .originPrice").textContent = formatNumber(parseInt(product.productPrice)) + " đ";
...
function addProductImages(productImage) {
    if (typeof productImage !== 'string') {
        console.error('Invalid product image provided:', productImage);
        return;
    }
